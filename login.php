...
<body class="flex items-center justify-center min-h-screen bg-gradient-to-r from-green-300 via-teal-300 to-cyan-400 relative overflow-hidden">
  ...
  <!-- Form -->
  <div class="w-full max-w-md p-10 bg-white rounded-2xl shadow-2xl relative z-10">
